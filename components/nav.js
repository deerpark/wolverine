...
const handleChangeRating = e => {
  ...
  Router.push(`/ranking/${_query.locale}/${e.currentTarget.dataset.ratings}/${_query.date}`)
}
  ...
  <nav className="nav">
    <ul>
      <li className="nav__left">
        <a href="/" onClick={handleClickToLoad} className="btn-home"><i className="fas fa-home" /></a>
      </li>
